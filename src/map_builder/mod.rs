...
impl MapBuilder {
    pub fn new(rng: &mut RandomNumberGenerator) -> Self {
        let mut architect: CellularAutomataArchitect = CellularAutomataArchitect {};
    ...
    fn spawn_monsters(&self, start: &Point, rng: &mut RandomNumberGenerator) -> Vec<Point> {
        ...
        for _ in 0..NUM_MONSTERS {
            let target_index: usize = rng.random_slice_index(&spawnable_tiles).unwrap();
